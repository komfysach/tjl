...
class BookingsPage extends Component {
    ...
    state = {
        ...
        currentDateTime: Date(new Date().setHours(0, 0, 0)).substring(0, 10)
    };
    ...
    render() {
        ...
        return (
            <div className="calendar">
                <h1 className='calendar_header'>Make a booking</h1>
                <AppointmentPicker
                    ...
                    initialDay={this.currentDateTime}
                    days={days}
